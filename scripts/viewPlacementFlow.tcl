...
set alib_dare_io_path [getenv BENCHMARK_GEN_ROOT]/alibs
...
##################################################
source -e -v [getenv BENCHMARK_GEN_ROOT]/${DESIGN_NAME}/scripts/${DESIGN_NAME}.common.tcl

# Read libraries specific to this design
source -e -v [getenv BENCHMARK_GEN_ROOT]/${DESIGN_NAME}/scripts/${DESIGN_NAME}.techlib.tcl
