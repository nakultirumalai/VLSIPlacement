...
if {${RTL_SRC_TYPE} == "vhdl"} {
    analyze -work work -format vhdl ${RTL_SRC_FILES}
} elseif {${RTL_SRC_TYPE} == "verilog"} {
    analyze -work work -format verilog ${RTL_SRC_FILES}
}
...
report_timing -max_paths 2000000 -sort_by slack > ${RESULT_DIR}/${DESIGN_NAME}_timing.rpt
