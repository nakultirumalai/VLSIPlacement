...
#    -row_core_ratio 0.7 
create_floorplan -control_type aspect_ratio -core_aspect_ratio 1.0 -core_utilization 0.75 

#create_fp_placement -optimize_pins -effort high

# CREATE PAD CELLS AND WRITE THEM OUT
genTermPlacement ${RESULT_DIR}/bookshelf/${DESIGN_NAME}.term.pl

write_def -output ${RESULT_DIR}/bookshelf/${DESIGN_NAME}.def
write_def -output ${RESULT_DIR}/${DESIGN_NAME}.def
